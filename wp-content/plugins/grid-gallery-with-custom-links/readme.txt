...
Plugin URI: http://abcfolio.com/wordpress-plugin-grid-gallery-with-custom-links-free-plugin/
...
= Live Previews = [http://abcfolio.com/demos/wordpress-grid-gallery/grid-gallery-with-custom-links-live-preview/](http://abcfolio.com/demos/wordpress-grid-gallery/grid-gallery-with-custom-links-live-preview/)


With the Grid Gallery, you can easily add elegant navigation option to any theme.

* You can add custom links and captions to any or all images.
* Easy to customize.
* Compatible with all browsers and mobile devices.
* Easy to add to any page or post - just insert a shortcode.


Requires our free [**Media Library Custom Fields**](http://abcfolio.com/wordpress-plugin-media-library-custom-fields/) plugin to be installed.

If you have a WordPress gallery of images and need to link them to other pages, this plugin is for you!

= User Guide =

Plugin documentation at [http://abcfolio.com/wordpress-plugin-grid-gallery-with-custom-links-free-plugin/](http://abcfolio.com/wordpress-plugin-grid-gallery-with-custom-links-free-plugin/).

= Premium Version =

[Grid Gallery with Custom Links Pro](http://abcfolio.com/wordpress-plugin-grid-gallery-with-custom-links/) premium version offers these extra features:

* **Responsive**, when used with responsive themes. [Preview.](http://abcfolio.com/demos/responsive/responsive-live-preview/)
* Additional text layouts. [Preview.](http://abcfolio.com/wordpress-plugin-grid-gallery-with-custom-links-text-layout/)
* Long description field.
* Additional visual options: image frames and drop shadow. [Preview.](http://abcfolio.com/wordpress-plugin-grid-gallery-with-custom-links-image-borders/)
...
* Fully customizable. You can add your own custom CSS file.
* Priority support.

[Visit our Premium Plugin page.](http://abcfolio.com/wordpress-plugin-grid-gallery-with-custom-links/)

== Installation ==

This plugin requires our free **Media Library Custom Fields** plugin to be installed!
Media Library Custom Fields is available for download from WordPress Plugins Directory. It is tested and fully compatible with **Grid Gallery with Custom Links**.
...
1. Help & documentation: [http://abcfolio.com/wordpress-plugin-grid-gallery-with-custom-links-free-plugin/](http://abcfolio.com/wordpress-plugin-grid-gallery-with-custom-links-free-plugin/).
